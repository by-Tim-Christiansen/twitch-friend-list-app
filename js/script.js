  ...
  function callIfOffline(name){
    ...
    request2.onload = function() {
      if (this.status >= 200 && this.status < 400) {
        ...
        toAppend += "<div class='container'> <div class='card'> <div class='card-body'> <img class='profil-pic' src='" + data2.logo + "' alt ='channel logo'> <h4 class='card-title'>" + name + "</h4> <br /> <p class='card-text'>" + data2.status + "</p> <a class='btn btn-off' href='" + data2.url + "' role='button'> OFFLINE </a> </div> </div> </div>";
